(function () {
  ...
  function saveForm() {
    ...
    storageData.options.disable_on_subscriptions = $('disable_on_subscriptions').checked;
  ...
  function populateForms(obj = undefined) {
    ...
    $('disable_on_subscriptions').checked = get('options.disable_on_subscriptions', false, obj);
